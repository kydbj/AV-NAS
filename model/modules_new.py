...
class CrossAtt(nn.Module):
    def __init__(self, __C, nrom=False, residual=False, base=64):
        super(CrossAtt, self).__init__()
        self.att = BertSelfAttention(__C, base=base)
...
class BertSelfAttention(nn.Module):
    def __init__(self, __C, D, norm=False, residual=False, base=64):
        ...
        self.query = nn.Linear(__C.HSIZE, self.all_head_size)
        self.key = nn.Linear(__C.HSIZE, self.all_head_size)
        self.value = nn.Linear(__C.HSIZE, self.all_head_size)
...
#         super().__init__()
#         self.dense = nn.Linear(__C.HSIZE, __C.intermediate_size)
...
#     def __init__(self, __C):
#         super().__init__()
#         self.dense = nn.Linear(__C.intermediate_size, __C.HSIZE)
#         self.dropout = nn.Dropout(__C.hidden_dropout_prob)
#         # self.LayerNorm = nn.LayerNorm(__C.HSIZE, eps=__C.layer_norm_eps)
#
...
class BertIntermediateOutput(nn.Module):
    def __init__(self, __C, norm=False, residual=False):
        super().__init__()
        self.dense1 = nn.Linear(__C.HSIZE, __C.intermediate_size)
        self.intermediate_act_fn = nn.functional.gelu
        self.dense2 = nn.Linear(__C.intermediate_size, __C.HSIZE)
        self.dropout = nn.Dropout(__C.hidden_dropout_prob)
...
class MLP_STD(nn.Module):
    def __init__(self, __C, norm=False, residual=False):
        ...
        self.in_proj = nn.Linear(__C.HSIZE, __C.HSIZE)
        self.conv1d = nn.Conv1d(in_channels=__C.HSIZE, out_channels=__C.HSIZE,
...
class MLP_CONV_UP(nn.Module):
    def __init__(self, __C, norm=False, residual=False):
        super(MLP_CONV_UP, self).__init__()
...
if __name__ == '__main__':
    ...
    # op1 = BertSelfAttention(__C,base=5).to('cuda:1')
    # op2 = BertSelfOutput(__C).to('cuda:1')


    # for n, p in op.named_parameters():
    #     print(n)

    # for n, p in op2.named_parameters():
    #     print(n)
    # #
    # inputs = (torch.ones((2,3,5))).to('cuda:1')
    #
    # output = op2(op1(inputs))
    # print(output.shape)